...
public class PageLoadTimeoutException extends RuntimeException {
	...
	public PageLoadTimeoutException(String message, String timeout) {
		super(message + " is not loaded in specified timeout of " + timeout
				+ " Seconds kindly refer attached screenshot for more clearification");
	}

	public PageLoadTimeoutException(String value, String timeout, Exception cause) {
		super(value + " is not loaded in specified timeout of " + timeout
