...
public class ElementNotFoundException extends RuntimeException {
	...
	public ElementNotFoundException(String element) {
		super("Unable to Find " + element + " kindly refer attached screenshot for more clearification");
	}

	public ElementNotFoundException(String element, Throwable cause) {
		super("Unable to Find " + element + " kindly refer attached screenshot for more clearification", cause);
	}
